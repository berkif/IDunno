...
public class GameResponse {
	...
	private GameResponse(Builder builder) {
		...
		this.rocketMoveToX = builder.rocketMoveToPosition.map(Point::x).orElse(null);
		this.rocketMoveToY = builder.rocketMoveToPosition.map(Point::y).orElse(null);
	...
	public static final class Builder {
		private Point shipMoveToPosition;
		private boolean shieldIsActivated = false;
		private Optional<Point> rocketMoveToPosition = Optional.empty();
		private boolean upgraded = false;

		private Builder() {
		}

		public Builder withShipMoveToPosition(Point position) {
		...
		public Builder withRocketMoveToPosition(Optional<Point> position) {
			this.rocketMoveToPosition = position;
			return this;
		}

		public Builder withRocketMoveToPosition(Point position) {
